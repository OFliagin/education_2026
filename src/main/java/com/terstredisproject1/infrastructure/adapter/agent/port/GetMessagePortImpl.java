...
import com.terstredisproject1.infrastructure.db.redis.RedisRequestRateLimiter;
...
public class GetMessagePortImpl implements GetMessagePort {
    ...
    private final RedisRequestRateLimiter redisRequestRateLimiter;
    ...
    public AgentResult execute(long userId, String message) {
        ...
        redisRequestRateLimiter.checkTokenBucketLimitLua(userId);
